...
class DataInitializer(
    ...
    fun initializeData(){
        ...
        val links = mutableListOf<Link>(
            Link(name = "Github", content = "https://github.com/jjr7181", isActive = true),
        ...
        project2.addDetails(
            mutableListOf(
                ...
                ProjectDetail(content = "Github Repository", url = "https://github.com/jjr7181", isActive = true)
            )
        )
